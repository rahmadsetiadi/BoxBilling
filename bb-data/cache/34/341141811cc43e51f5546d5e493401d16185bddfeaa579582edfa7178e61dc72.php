...
/* partial_menu.phtml */
class __TwigTemplate_d9be9dffe0a8ca2ee1411525d1e46fee02d45394f0b4a87ef150e83bfc440acc extends \Twig\Template
{
    private $source;
    private $macros = [];
...
{% for location,group in navigation %}
    ...
    {% endif %}
{% endfor %}
</ul>", "partial_menu.phtml", "/var/www/html/bb-themes/admin_default/html/partial_menu.phtml");
    }
}
